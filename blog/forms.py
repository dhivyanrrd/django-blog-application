...
class RegisterForm(forms.ModelForm):
    ...
    password_confirm= forms.CharField(label='Confirm Password',max_length=150,  required=True)
...
class ResetPasswordForm(forms.Form):
    new_password= forms.CharField(label="New Password", max_length=150, required=True)
    confirm_password= forms.CharField(label="Confirm Password", max_length=150, required=True)
...
class PostForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        if cleaned_data.get('img_url'):
            ...
            img_url ="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/960px-No_image_available.svg.png?20251111182856"
